...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/arxiv-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=13046&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/arxiv-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `arxiv` can be installed with:

```
conda install arxiv
```

It is possible to list all of the versions of `arxiv` available on your platform with:
